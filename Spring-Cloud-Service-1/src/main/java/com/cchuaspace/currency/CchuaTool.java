...
public class CchuaTool {
    ...
    public int getCommodityNumber(int father) {
        int CommodityNumber;
        ...
        CommodityNumber = father + nowTimeStamp + getrandomNumber(10000000, 1000000) + getrandomNumber(1000, 9999);
        CommodityNumber=Math.abs(CommodityNumber);
    ...
    public String henuuid() {

        UUID uuid = UUID.randomUUID();
        System.out.print(uuid.toString().replaceAll("\\-", ""));
