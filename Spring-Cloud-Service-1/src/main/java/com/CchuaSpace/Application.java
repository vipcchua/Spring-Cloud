...
import com.cchuaspace.service.HelloService;
...
public class Application {
	...
	public SqlSessionFactoryBean sqlSessionFactory() throws Exception {
		...
		sessionFactory.getObject().getConfiguration().setMapUnderscoreToCamelCase(
				true);



		sessionFactory.getObject().getConfiguration().setAggressiveLazyLoading(true);

		sessionFactory.getObject().getConfiguration().setDefaultStatementTimeout(25000);
	...
	public MapperScannerConfigurer mapperin() {
		...
		MapperScannerConfigurer mapperScannerConfigurer = new MapperScannerConfigurer();
		  mapperScannerConfigurer.setBasePackage("com.cchuaspace.mapper");
    ...
    @Bean(name="Hellow Bean")
@Lazy(true)
    public HelloService HelloServicefilterRegistrationBean(){

//     <bean id="helloService" class="com.cchuaspace.service.HelloService" lazy-init='true'/>


                HelloService ds = new HelloService();
    ...
    public static void main(String[] args) {
		...
		/* 后台版本号 */
        logger.info("Backstage Versions:3.6\n");
